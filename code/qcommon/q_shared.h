...
#endif
/*
// if your system does not have lrintf() and round() you can try this block. Please also open a bug report at
...
#define PlaneTypeForNormal(x)                                                                                          \
	(x[0] == 1.0 ? PLANE_X : (x[1] == 1.0 ? PLANE_Y : (x[2] == 1.0 ? PLANE_Z : PLANE_NON_AXIAL)))
...
#define CLIENT_DO_IT_SPRAYROOM_GOODBYE 0
#define CLIENT_DO_IT_SPRAYED_ON_WRONG_WALL 1
#define CLIENT_DO_IT_LPS_LOST 2
#define CLIENT_DO_IT_SELECT_LOGO 3
